defmodule Buzzword.Bingo.LiveWeb.CoreComponents do
  @moduledoc """
  ...
  def flash(%{kind: kind} = assigns) do
    assigns = assign_new(assigns, :id, fn -> "flash-#{kind}" end)
    ...
    >
      ...
      <p class="mt-2 text-sm leading-5">
        <%= (is_binary(msg) && Phoenix.HTML.raw(msg)) || msg %>
      </p>
      <button
        type="button"
  ...
  def guides_and_docs_svg(assigns) do
    ~H"""
  ...
  def source_code_svg(assigns) do
    ~H"""
  ...
  attr :class, :string,
    default: "h-4 w-4 fill-zinc-400 group-hover:fill-zinc-600"

  def follow_on_twitter_svg(assigns) do
    ~H"""
  ...
  def discuss_on_the_elixir_forum_svg(assigns) do
    ~H"""
    <svg
      viewBox="0 0 16 16"
      aria-hidden="true"
  ...
  def join_our_slack_channel_svg(assigns) do
    ~H"""
    <svg
      viewBox="0 0 16 16"
      aria-hidden="true"
  ...
  def chat_on_libera_irc_svg(assigns) do
    ~H"""
    <svg
      viewBox="0 0 16 16"
      aria-hidden="true"
  ...
  def join_our_discord_server_svg(assigns) do
    ~H"""
    <svg
      viewBox="0 0 16 16"
      aria-hidden="true"
  ...
  def deploy_your_application_svg(assigns) do
    ~H"""
    <svg
      viewBox="0 0 20 20"
      aria-hidden="true"
